# surround-panorama Specification

## Purpose

GPU equirectangular surround stitch of the 4 fisheye cameras into a single `/bev/panorama` image for
visualization (rviz / optional video), running in the existing TX2 cuVSLAM container.
